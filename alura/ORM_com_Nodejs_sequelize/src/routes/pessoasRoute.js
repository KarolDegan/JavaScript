...
router.get('/pessoa/:estudanteId/matriculas', (req, res) => pessoaController.pegaMatricula(req, res));
router.post('/pessoa/:estudanteId/matriculas', (req, res) => matriculaController.criaNovo(req, res));
